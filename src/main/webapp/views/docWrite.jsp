		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-danger" onclick="lineClear()">초기화</button>
		...
		<div class="row" style="padding: 10px;">
			...
			<div class="col-sm-3">
				<button type="button" id="selLineCall" class="btn btn-primary"
					data-bs-toggle="modal" data-bs-target="#myModal">결재 라인 지정</button>
			</div>
		</div>
		<div class="row">
			<div class="col-sm-2">
